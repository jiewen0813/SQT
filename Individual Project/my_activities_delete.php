...
if(isset($_GET["id"]) && $_GET["id"] != "") {
    ...
    $getImagePathQuery = "SELECT img_path FROM activities WHERE ac_id=" . $id;
    ...
    if ($result && $row = mysqli_fetch_assoc($result)) {
        ...
        $deleteActivitiesQuery = "DELETE FROM activities WHERE ac_id=" . $id;
        if (mysqli_query($conn, $deleteActivitiesQuery)) {
