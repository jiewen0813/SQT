...
$sql = "SELECT * FROM activities WHERE ac_id=" . $_GET["id"];
//echo $sql . "<br>";
...
<input type="text" id="ac_id" name="ac_id" value="<?= isset($_GET['id']) ? $_GET['id'] : '' ?>" hidden>
...
<td>:</td>
<td>
<textarea rows="4" name="activities" cols="30" required><?php echo $activities;?></textarea>
</td>
</tr>
<tr>
<td>Position*</td>
<td>:</td>
<td>
<textarea rows="4" name="position" cols="30" required><?php echo $position;?></textarea>
</td>
</tr>
<tr>
<td>Photo</td>
